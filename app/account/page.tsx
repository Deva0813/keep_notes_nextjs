                                ...
                                <div className="left-details flex flex-col xl:flex-row pb-5  ">
                                    ...
                                    <div className="personal-info grid grid-flow-row gap-2 md:gap-0 md:grid-cols-2 w-full ">
                                        <div className="flex flex-col md:px-5 md:pt-5 gap-2 md:w-full ">
                                            ...
                                            <input className="border-2 text-cursor border-btn_add-700 rounded-md p-2 focus:border-btn_add-800 focus:outline-none transition-all ease-in-out delay-150" type="text" placeholder="First Name" />
                                        </div>
                                        <div className="flex flex-col md:px-5 md:pt-5 gap-2 md:w-full ">
                                            <label className="text-sm font-semibold pl-2 " >Last Name</label>
                                            <input className="border-2 text-cursor border-btn_add-700 rounded-md p-2 focus:border-btn_add-800 focus:outline-none transition-all ease-in-out delay-150" type="text" placeholder="Last Name" />
                                        </div>
                                        <div className="flex flex-col md:px-5 md:pt-5 gap-2 md:w-full ">
                                            <label className="text-sm font-semibold pl-2 " >Age</label>
                                            <input className="border-2 text-cursor border-btn_add-700 rounded-md p-2 focus:border-btn_add-800 focus:outline-none transition-all ease-in-out delay-150" type="text" placeholder="Age" />
                                        </div>
                                        <div className="flex flex-col md:px-5 md:pt-5 gap-2 md:w-full ">
                                            <label className="text-sm font-semibold pl-2 ">Gender</label>
                                            <select className="border-2 default border-btn_add-700 rounded-md p-2 focus:border-btn_add-800 focus:outline-none transition-all ease-in-out delay-150" >
                                        ...
                                        <div className="flex flex-col md:px-5 md:pt-5 gap-2 md:w-full ">
                                            ...
                                            <input className="border-2 text-cursor border-btn_add-700 rounded-md p-2 focus:border-btn_add-800 focus:outline-none transition-all ease-in-out delay-150" type="tel" placeholder="Phone Number" />
                                        </div>
                                    </div>
                                </div>

                                <div className="left-details flex flex-col xl:flex-row  border-b-2 border-btn_add-500 ">
                                    <div className="w-full xl:w-1/3 py-5 ">
                                        <p className="text-sm px-5 xl:p-5" >
                                    ...
                                    <div className="personal-info grid grid-flow-row gap-2 md:gap-0 md:grid-cols-2 w-full ">
                                        <div className="flex flex-col md:px-5 md:pt-5 gap-2 md:w-full ">
                                            ...
                                            <input className="border-2 text-cursor border-btn_add-700 rounded-md p-2 focus:border-btn_add-800 focus:outline-none transition-all ease-in-out delay-150" type="text" placeholder="Username" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="left-details flex flex-col xl:flex-row ">
                                    ...
                                    <div className="personal-info grid grid-flow-row gap-2 md:gap-0 md:grid-cols-2 w-full ">
                                        <div className="flex flex-col md:px-5 md:pt-5 gap-2 md:w-full ">
                                            ...
                                            <input className="border-2 text-cursor border-btn_add-700 rounded-md p-2 focus:border-btn_add-800 focus:outline-none transition-all ease-in-out delay-150" type="email" placeholder="Email" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-col w-full my-5 md:m-5 p-10 bg-white border-2 border-btn_add-700 rounded-xl text-btn_add-800 ">
                                ...
                                <div className="left-details flex flex-col xl:flex-row pb-5  ">
                                    ...
                                    <div className="flex flex-col md:px-5 md:pt-5 gap-2 md:w-full ">
                                        ...
                                        <input className="border-2 text-cursor border-btn_add-700 rounded-md p-2 focus:border-btn_add-800 focus:outline-none transition-all ease-in-out delay-150" type="password" placeholder="New Password" />
                                    </div>
